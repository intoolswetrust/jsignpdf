...
public class RelRect {
    ...
    /**
     * Return if the rectangle is valid (i.e. both startPoint and endPoint are set correctly)
     * 
    ...
    /**
     * Returns relative coordinates of the startPoint [x1,y1] and endPoint [x2,y2] as Float array [x1,y1,x2,y2]
     * 
     * @return
     */
     ...
     * Sets the end Point
     * 
     * @param aPoint the endPoint to set
     */
     ...
     * 
     * @param coordsOffset use 0 for startPoint and 2 for endPoint.
    ...
    /**
     * Sets coordinates of a relative point (startPoint or endPoint) based on given Point in the image.
     * 
