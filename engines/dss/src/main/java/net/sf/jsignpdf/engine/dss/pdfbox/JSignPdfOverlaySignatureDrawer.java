...
public class JSignPdfOverlaySignatureDrawer extends AbstractPdfBoxSignatureDrawer {
     ...
     * replicates the setup from {@code AbstractPdfBoxSignatureDrawer.init()} — including the
     * {@code checkColorSpace()} call that registers the output intent — but applies a validation
     * that respects the background-image field.
     */
    @Override
