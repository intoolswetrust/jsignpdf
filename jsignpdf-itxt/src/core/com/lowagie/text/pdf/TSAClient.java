/*
 * $Id: TSAClient.java,v 1.1 2010/04/14 17:50:31 kwart Exp $
 *
 ...
 * <p>
 * Interface used by the PdfPKCS7 digital signature builder to call Time Stamp
 * Authority providing RFC 3161 compliant time stamp token.
 * 
...
public interface TSAClient {
	/**
	 * Get the time stamp token size estimate. Implementation must return value
	 * large enough to accomodate the entire token returned by
	 * getTimeStampToken() _prior_ to actual getTimeStampToken() call.
	 * 
