/*
 * $Id: OcspClientBouncyCastle.java,v 1.2 2010/06/04 06:35:53 kwart Exp $
 *
...
public class OcspClientBouncyCastle implements OcspClient {
	...
	private static OCSPReq generateOCSPRequest(X509Certificate issuerCert, BigInteger serialNumber)
		...
		values.add(new X509Extension(false, new DEROctetString(new DEROctetString(PdfEncryption.createDocumentId())
				.getEncoded())));
