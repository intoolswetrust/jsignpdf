...
public class ConvertUtils {
    ...
    /**
     * Converts given value to int, if it is possible. When the conversion fails (null value) the given default value is
     * returned
     * 
    ...
    /**
     * Converts given value to float, if it is possible. When the conversion fails (null value) the given default value is
     * returned
     * 
     * @param anObj value to convert
     * @param aDefault default value
    ...
    /**
     * Converts given value to boolean, if it is possible. When the conversion fails (null value) the given default value is
     * returned
     * 
     * @param anObj value to convert
     * @param aDefault default value
