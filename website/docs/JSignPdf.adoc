...
the signature lands. The combo stays on _(create new field)_ for documents without empty fields, and the
selection is reset whenever you open another document.
