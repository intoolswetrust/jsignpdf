...
public class SignerOptionsFromCmdLine extends BasicSignerOptions {
	...
	static {
		...
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_VERSION_LONG).withDescription(res.get("hlp.version")).create(
				ARG_VERSION));
		...
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_LOADPROPS_FILE_LONG).withDescription(
				res.get("hlp.loadPropertiesFile")).hasArg().withArgName("file").create(ARG_LOADPROPS_FILE));
		...
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_LIST_KEYS_LONG).withDescription(res.get("hlp.listKeys")).create(
				ARG_LIST_KEYS));
		...
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_APPEND_LONG).withDescription(res.get("hlp.append")).create(
				ARG_APPEND));
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_CERT_LEVEL_LONG).withDescription(
				res.get("hlp.certLevel", getEnumValues(CertificationLevel.values()))).hasArg().withArgName("level")
				.create(ARG_CERT_LEVEL));
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_HASH_ALGORITHM_LONG).withDescription(
				res.get("hlp.hashAlgorithm", getEnumValues(HashAlgorithm.values()))).hasArg().withArgName("algorithm")
		...
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_ENCRYPTED_LONG).withDescription(res.get("hlp.encrypted")).create(
				ARG_ENCRYPTED));
		...
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_RIGHT_PRINT_LONG).withDescription(
				res.get("hlp.printRight", getEnumValues(PrintRight.values()))).hasArg().withArgName("right").create(
				ARG_RIGHT_PRINT));
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_DISABLE_COPY_LONG).withDescription(res.get("hlp.disableCopy"))
				.create());
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_DISABLE_ASSEMBLY_LONG).withDescription(
				res.get("hlp.disableAssembly")).create());
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_DISABLE_FILL_LONG).withDescription(res.get("hlp.disableFill"))
				.create());
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_DISABLE_SCREEN_READERS_LONG).withDescription(
				res.get("hlp.disableScrRead")).create());
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_DISABLE_MODIFY_ANNOT_LONG).withDescription(
				res.get("hlp.disableAnnot")).create());
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_DISABLE_MODIFY_CONTENT_LONG).withDescription(
				res.get("hlp.disableContent")).create());

		// visible signature options
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_VISIBLE_LONG).withDescription(res.get("hlp.visible")).create(
				ARG_VISIBLE));
		OPTS.addOption(OptionBuilder.withLongOpt(ARG_PAGE_LONG).withDescription(res.get("hlp.page")).hasArg().withType(
				Number.class).withArgName("pageNumber").create(ARG_PAGE));
		...
		OPTS.addOption(OptionBuilder.withDescription(
				res.get("hlp.l2TextFontSize", String.valueOf(Constants.DEFVAL_L2_FONT_SIZE))).withLongOpt(
				ARG_L2TEXT_FONT_SIZE_LONG).hasArg().withType(Number.class).withArgName("size").create(
				ARG_L2TEXT_FONT_SIZE));
		...
		OPTS.addOption(OptionBuilder.withDescription(
				res.get("hlp.proxyType", DEFVAL_PROXY_TYPE.name(), getEnumValues(Proxy.Type.values()))).withLongOpt(
				ARG_PROXY_TYPE_LONG).hasArg().withArgName("type").create());
