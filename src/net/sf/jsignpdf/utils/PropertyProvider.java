...
public class PropertyProvider {
	...
	/**
	 * Creates new instance of PropertyProvider and loads default properties -
	 * if exist.
	 */
	...
	/**
	 * Save current set of properties holded by PropertyProvider to a given
	 * file.
	 * 
	 * @param aFile
	 ...
	 * 
	 * @param aKey
	 * @return value from properties converted to integer (if value doesn't
	 *         exist, 0 is returned)
	 * @see #exists(String)
	 */
	...
	/**
	 * Returns value for given key converted to integer; If property doesn't
	 ...
	 * 
	 * @param aKey
	 * @return value from properties converted to long (if value doesn't exist,
	 *         0 is returned)
	 * @see #exists(String)
	 */
	 ...
	 * 
	 * @param aKey
	 * @return value from properties converted to boolean (if value doesn't
