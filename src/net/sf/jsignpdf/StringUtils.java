...
public class StringUtils {
	...
	/**
	 * Returns oposite value than {@link #isEmpty(Object)} method
	 * 
	 * @param aValue
	 *            value
	 ...
	 * @see #isEmpty(Object)
	 */
	public static boolean hasLength(final Object aValue) {
		return !isEmpty(aValue);
	}

	/**
	 * Converts String to charArray. If null is provided as a string, null is
	 * returned.
	 * 
	 * @param aValue
	 * @return char array or null
	 */
	public static char[] toCharArray(final String aValue) {
		return aValue == null ? null : aValue.toCharArray();
	}

	/**
	 * Converts String to byte array in given charset. If null is provided as a
	 * string, null is returned.
	 * 
	 * @param aValue
	 * @param aCharset
	 *            charset name (or null for default)
	 * @return byte array or null
	 */
	public static byte[] toByteArray(final String aValue, String aCharset) {
		if (aValue == null)
			return null;
		...
		if (aValue != null) {
			if (aCharset != null) {
				try {
					tmpResult = aValue.getBytes(aCharset);
				} catch (UnsupportedEncodingException e) {
					logger.warn("Unsupported charset name", e);
				}
			}
			if (tmpResult == null) {
				tmpResult = aValue.getBytes();
			}
		}
		return tmpResult;
	}
