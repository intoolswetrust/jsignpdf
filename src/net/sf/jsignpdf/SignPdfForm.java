...
public class SignPdfForm extends javax.swing.JFrame implements SignResultListener {
  ...
  private void refreshView() {
    ...
    boolean encryptionEnabled = chkbAdvanced.isSelected() && chkbPdfEncrypted.isSelected();
    ...
    chkbPdfEncrypted.setVisible(advanced);
    ...
    lblPdfOwnerPwd.setVisible(encryptionEnabled);
    pfPdfOwnerPwd.setVisible(encryptionEnabled);

    lblPdfUserPwd.setVisible(encryptionEnabled);
    pfPdfUserPwd.setVisible(encryptionEnabled);
