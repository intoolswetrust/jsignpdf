...
public class BasicSignerOptions {
  ...
  public void setCertLevel(String aValue) {
    ...
    if (aValue != null) {
      try {
        certLevel = CertificationLevel.valueOf(aValue.toUpperCase());
      } catch (Exception e) {
  ...
  public void setRightPrinting(String aValue) {
    ...
    if (aValue != null) {
      try {
        printRight = PrintRight.valueOf(aValue.toUpperCase());
      } catch (Exception e) {
        //probably illegal value - fallback to a default (i.e. null)
      }
    }
  ...
  public void setRenderMode(String aValue) {
    ...
    if (aValue != null) {
      try {
        renderMode = RenderMode.valueOf(aValue.toUpperCase());
      } catch (Exception e) {
  ...
  public void setHashAlgorithm(String aValue) {
    ...
    if (StringUtils.isNotEmpty(aValue)) {
      try {
        hashAlg = HashAlgorithm.valueOf(aValue.toUpperCase());
      } catch (Exception e) {
        //probably illegal value - fallback to a default (i.e. null)
      }
    }
  ...
  public void setProxyType(final String aValue) {
    ...
    if (StringUtils.isNotEmpty(aValue)) {
      try {
        proxy = Proxy.Type.valueOf(aValue.toUpperCase());
      } catch (Exception e) {
        //probably illegal value - fallback to a default (i.e. null)
      }
    }
  ...
  /**
   * Creates and returns Proxy object, which should be used for URL connections
   * in JSignPdf.
   * 
