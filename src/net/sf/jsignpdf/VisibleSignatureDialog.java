...
public class VisibleSignatureDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		lblL2Text1 = new javax.swing.JLabel();
		...
		getContentPane().add(lblL2Text, new java.awt.GridBagConstraints());
		...
		lblL2Text1.setLabelFor(tfL2Text);
		lblL2Text1.setText("Signature text");
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 0;
		gridBagConstraints.gridy = 8;
		gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
		gridBagConstraints.insets = new java.awt.Insets(2, 5, 2, 5);
		getContentPane().add(lblL2Text1, gridBagConstraints);
	...
	private javax.swing.JLabel lblL2Text1;
