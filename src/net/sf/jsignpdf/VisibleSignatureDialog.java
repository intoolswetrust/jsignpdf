...
import net.sf.jsignpdf.preview.RelRect;
...
public class VisibleSignatureDialog extends javax.swing.JDialog {
	...
	public VisibleSignatureDialog(java.awt.Frame parent, boolean modal, final BasicSignerOptions anOptions,
		...
		selectionImage.getRelRect().addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				tfPosLLX.setText(String.valueOf(tmpRect.getRelLeft() * pdfPageSize[0]));
				tfPosLLY.setText(String.valueOf((1 - tmpRect.getRelBottom()) * pdfPageSize[1]));
				tfPosURX.setText(String.valueOf(tmpRect.getRelRight() * pdfPageSize[0]));
				tfPosURY.setText(String.valueOf((1 - tmpRect.getRelTop()) * pdfPageSize[1]));
			}
		});
	...
	private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnPreviewActionPerformed
		...
		if (pageNr != null) {
			...
			// TODO set relRect in selection image - we want to have preview!
			...
			if (buffImg != null) {
				final RelRect tmpRect = selectionImage.getRelRect();
				try {
					tmpRect.scale(getInt(pdfPageSize[1]), getInt(pdfPageSize[0]));
					tmpRect.setStartPoint(new Point(getInt(Float.parseFloat(tfPosLLX.getText())), getInt(Float
							.parseFloat(tfPosLLY.getText()))));
					tmpRect.setEndPoint(new Point(getInt(Float.parseFloat(tfPosURX.getText())), getInt(Float
							.parseFloat(tfPosURY.getText()))));
				} catch (Exception e) {
					// TODO
				}
		...
		selectionImage.setImage(p2i.getImageForPage(ConvertUtils.toInteger(tfPage.getText())));
